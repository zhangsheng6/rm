...
typedef __packed struct __MPU6050_OFFEST_Data__
{
	 float garo_X_offest;
	 float garo_Y_offest;
	 float garo_Z_offest;
	 float accel_X_offest;
	 float accel_Y_offest;
	 float accel_Z_offest;	
	 float pitch_offest;
	 float yaw_offest;
	 float roll_offest;
	 unsigned char  offest_flag;
}MPU6050_OFFEST_DATA;
